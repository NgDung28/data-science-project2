...
def load_data(messages_filepath, categories_filepath):
    """
    Load and merge datasets from 2 filepaths.
    ...
    Output:
    df: dataframe merged by messages and categories
...
def clean_data(df):
    ...
    # converts values to binary in related column
...
def save_data(df, database_filepath):
    """Stores result in a SQLite database."""
